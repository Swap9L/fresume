...
/**
 * SmartNavbar — rendered globally in root layout.
 * - On /{username} pages: renders nothing (the portfolio page handles its own full dock)
 * - On admin/auth pages: renders a minimal theme-only dock
 * - On the landing page (/): renders a minimal theme-only dock
 */
export function SmartNavbar() {
    ...
    // Auth pages — no dock at all
    if (pathname.startsWith("/auth")) return null;

    // Everything else (admin, landing, etc.) — theme-only dock
